    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vancouver", 100, "BC", null },
                    { 2, "Surrey", 150, "BC", null },
                    { 3, "Richmond", 90, "BC", null },
                    { 4, "Edmonton", 191, "ALB", null },
                    { 5, "Calgary", 102, "ALB", null },
                    { 6, "Red Dear", 1000, "ALB", null },
                    { 7, "Winnipeg", 10034, "MAN", null },
                    { 8, "Brandon", 90, "MAN", null },
                    { 9, "Morden", 201, "MAN", null }
                });
